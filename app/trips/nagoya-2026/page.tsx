...
export default function Nagoya() {
  ...
  async function handleShare() {
    const blob = await buildPhotoGridShareCard(GALLERY.map(g => g.url), { kicker: "TRAVEL ARCHIVE", title: "Nagoya", subtitle: "Takayama · Inuyama", backdropColor: BG, footerTop: "Winter 2026", footerBottom: "6 Days" });
    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: "-apple-system, 'Helvetica Neue', sans-serif", color: TEXT }}>
      ...
      <div ref={heroRef} style={{ position: "relative", overflow: "hidden", backgroundColor: "#0d1a28" }}>
        ...
        >
          ...
          >
            Nagoya<br />
            <span style={{ fontSize: "clamp(16px, 3vw, 36px)", color: "rgba(255,255,255,0.65)" }}>Takayama · Inuyama</span>
          </motion.div>
