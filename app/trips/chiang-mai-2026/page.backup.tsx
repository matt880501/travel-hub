...
export default function ChiangMai() {
  ...
  const itinerary: Day[] = [
    {
      ...
      items: [
        ...
        { time: "14:00", type: "place", text: "One Nimman", mapUrl: "https://www.google.com/maps/search/One+Nimman+Chiang+Mai", note: "清邁最美紅磚文創區，適合散步拍照。尼曼區算好逛，比古城區環境好，步調舒服，後來覺得住這不錯。" },
        ...
        { time: "20:00", type: "place", text: "Nimman House Massage", mapUrl: "https://www.google.com/maps/search/Nimman+House+Massage+Chiang+Mai", note: "就是愛按摩。" },
      ]
    },
    {
      ...
      items: [
        ...
        { time: "10:30", type: "place", text: "湄康瀑布 & 村落寺廟", mapUrl: "https://www.google.com/maps/search/Mae+Kampong+Chiang+Mai", note: "溪流與森林包圍的百年木造村落，這裡滿不錯的。" },
        { time: "13:00", type: "food", text: "The Giant Chiang Mai", mapUrl: "https://www.google.com/maps/search/The+Giant+Chiang+Mai", note: "就是一棵大樹。" },
    ...
    },
    {
      ...
      items: [
        ...
        { time: "10:30", type: "place", text: "泰國最高峰 & 雙王塔", mapUrl: "https://www.google.com/maps/search/Doi+Inthanon+National+Park", note: "雲海花園。" },
        { time: "13:00", type: "place", text: "Kiew Mae Pan 步道", mapUrl: "https://www.google.com/maps/search/Kiew+Mae+Pan+Trail+Doi+Inthanon", note: "2 小時高山健行，台灣的山比較漂亮哈哈。" },
        { time: "15:30", type: "place", text: "Wachirathan 瀑布", mapUrl: "https://www.google.com/maps/search/Wachirathan+Waterfall+Chiang+Mai", note: "瀑布好美。" },
  ...
  const extras = [
    { text: "換匯找 Mr. Pierre", note: "路上很多坑盤子的別亂換，選這間就對了。V.K. Currency Exchange 也還行。" },
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#e8e5de", fontFamily: "-apple-system, Inter, sans-serif", color: "#222" }}>
      ...
      {/* Hero */}
      <div style={{ position: "relative", height: 420, backgroundImage: "url(https://res.cloudinary.com/dydhvvubl/image/upload/v1778430032/CM1_syxfa2.jpg)", backgroundSize: "cover", backgroundPosition: "center 30%", display: "flex", alignItems: "flex-end", padding: 40, overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px" }}>
        ...
        {/* Gallery */}
        <div style={{ borderTop: "0.5px solid #d4d0c8", paddingTop: 48, marginTop: 48 }}>
          <div style={{ fontSize: 10, color: "#999", letterSpacing: "0.15em", marginBottom: 24 }}>GALLERY</div>
          <div style={{ display: "flex", gap: 10 }}>
            {[[GALLERY[0],GALLERY[3],GALLERY[6]], [GALLERY[1],GALLERY[4],GALLERY[7]], [GALLERY[2],GALLERY[5],GALLERY[8]]].map((col, ci) => (
              <div key={ci} style={{ flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
                {col.map((img, i) => (
                  <div key={i} onClick={() => setLightbox(img.url)} style={{ borderRadius: 10, overflow: "hidden", cursor: "zoom-in" }}>
                    <img src={img.url} style={{ width: "100%", height: "auto", display: "block", transition: "transform 0.3s" }}
