...
export default function Tokyo2024() {
  ...
  async function handleShare() {
    const blob = await buildPhotoGridShareCard(GALLERY.map(g => g.url), { kicker: "TRAVEL ARCHIVE", title: "Tokyo", subtitle: "Kawaguchiko · Harajuku · Shibuya", backdropUrl: HERO_URL });
