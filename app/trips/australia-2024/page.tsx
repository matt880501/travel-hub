...
const GALLERY_ROWS: GalleryPhoto[][] = [
  ...
  [
    ...
    { url: "https://res.cloudinary.com/dydhvvubl/image/upload/f_auto,q_auto/v1778886135/AUs18_bcxab1.jpg", caption: "seeya", location: "Loch Ard Gorge" },
...
export default function Australia() {
  ...
  async function handleShare() {
    const blob = await buildPhotoGridShareCard(GALLERY_ROWS.flat().map(g => g.url), { kicker: "TRAVEL ARCHIVE", title: "Australia", subtitle: "Sydney · Melbourne · Great Ocean Road", backdropColor: BG, footerTop: "Aug 2024", footerBottom: "15 Days" });
    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: "-apple-system, 'Helvetica Neue', sans-serif", color: TEXT }}>
      ...
      <div ref={heroRef} style={{ position: "relative", overflow: "hidden", backgroundColor: "#1a120a", minHeight: HERO_URL ? undefined : (isMobile ? "60vw" : "85vh") }}>
        ...
        >
          ...
          >
            Australia<br />
            <span style={{ fontSize: "clamp(15px, 2.6vw, 34px)", color: "rgba(255,255,255,0.6)" }}>Sydney · Melbourne · Great Ocean Road</span>
          </motion.div>
